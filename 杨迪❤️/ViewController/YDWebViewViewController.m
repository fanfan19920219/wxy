...
-(void)createwebSlideView{
    ...
    self.openSlidButton.frame = CGRectMake(ScreenWidth - 50, ScreenHeight - 50, 30, 30);
...
//        [_webView loadRequest:[NSURLRequest requestWithURL:pathURL]];
       ...
       NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:@"http://i.meituan.com/"]];
